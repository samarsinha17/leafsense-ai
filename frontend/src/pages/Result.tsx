        ...
        <Card>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="flex min-h-32 min-w-0 flex-col items-center justify-center overflow-hidden rounded-2xl bg-primary/10 p-4 text-center">
              ...
              <p className={`mt-2 max-w-full whitespace-nowrap text-center text-xl font-bold leading-none tracking-tight xl:text-[1.35rem] ${severityClass}`}>{result.severity}</p>
            </div>
          </div>
